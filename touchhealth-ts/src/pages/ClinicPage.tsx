  ...
  return (
    <div style={{ padding: '24px 28px', background: '#f8fafc', minHeight: '100vh' }}>
      ...
      <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', marginBottom: 16 }}>
        <ClinicStatCard label="Expected Today" value={countExpected} color="#d97706" sub={countExpected > 0 ? 'still waiting' : 'none pending'} />
        <ClinicStatCard label="Seen Today" value={countSeen} ring total={totalToday || 1} color="#16a34a" sub={`of ${totalToday} scheduled`} />
        <ClinicStatCard label="Overdue" value={countOverdue} color="#dc2626" sub="missed appointment" />
        <ClinicStatCard label="Active Patients" value={allRows.length} color="#005469" sub="in programme" />
      </div>

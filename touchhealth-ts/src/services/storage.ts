...
export function loadSMSConfig(): SMSConfig {
  return load<SMSConfig>(KEYS.SMS_CONFIG, {
    ...
    atUsername: '',
    senderId: 'RemoteCare',
    template:    'Dear {name}, your appointment at {hospital} is on {date}. RemoteCare.',
    templateSw:  'Habari {name}, ziara yako katika {hospital} ni tarehe {date}. RemoteCare.',
    templateMissed:    'Dear {name}, you missed your clinic visit at {hospital}. Please return as soon as possible. RemoteCare.',
    templateMissedSw:  'Habari {name}, ulikosa kliniki yako katika {hospital}. Tafadhali rudi haraka iwezekanavyo. RemoteCare.',
    templateLtfu:      'Dear {name}, we have missed you at {hospital}. Please return to continue your treatment. RemoteCare.',
    templateLtfuSw:    'Habari {name}, tumekukosa katika {hospital}. Tafadhali rudi kuendelea na matibabu yako. RemoteCare.',
    templateWelcome:   'Welcome {name}! Your first appointment at {hospital} is on {date}. RemoteCare.',
    templateWelcomeSw: 'Karibu {name}! Ziara yako ya kwanza katika {hospital} ni tarehe {date}. RemoteCare.',
  });
}

-- ════════════════════════════════════════════════════════════
-- REMOTECARE · Supabase Database Schema (Complete)
...
-- ════════════════════════════════════════════════════════════
-- 1. USERS TABLE (App users - admins and doctors)
-- ════════════════════════════════════════════════════════════
CREATE TABLE users (
...
-- ════════════════════════════════════════════════════════════
-- 5. MEDICATIONS TABLE (Visit prescriptions)
-- ════════════════════════════════════════════════════════════
...
-- ════════════════════════════════════════════════════════════
-- 6. PATIENT MEDICATIONS TABLE (Patient-level history)
-- ════════════════════════════════════════════════════════════
